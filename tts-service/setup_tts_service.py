...
def main() -> None:
  ...
  write_text(root / "tts_server.py", TTS_SERVER_CODE)
  write_text(root / "requirements-tts.txt", "fastapi\nuvicorn\nedge-tts\n")
  write_text(root / "install_deps.sh", "python -m pip install -r requirements-tts.txt\n")
  write_text(
  ...
  print("已生成文件：")
  print("- tts_server.py")
  print("- requirements-tts.txt")
  print("- install_deps.sh")
  print("- install_deps.bat")
  print("")
  print("下一步：")
  print("1. 运行: python -m pip install -r requirements-tts.txt")
  print("2. 运行: python tts_server.py")
  print("3. 访问: http://127.0.0.1:8000/announce?name=白白&delta=1000")
